...
export default class Linelist extends React.Component {
    ...
    */
    ...
    getpoint = (linecom) =>{
        ...
        const pointwaylist = [];
        let en = {x:linecom.to.x,y:linecom.to.y};
        ...
        for(let i = 0;i < pointwaylist.length;i++){
            if(this.getpointlistarray(pointwaylist[i].pointlist,fromstr,i)){
                this.state.linelist = this.state.linelist.concat(pointwaylist[i].fromlist,pointwaylist[i].pointlist);
        ...
        for(let i = 0;i < pointlist.length;i++){
            if(pointlist[i].from.x === pointlist[i].to.x){
                if(pointlist[i].from.y > pointlist[i].to.y){
                    inter:for(let j = 0;j < pointlist[i].from.y - pointlist[i].to.y;j++){
                ...
                if(pointlist[i].from.y < pointlist[i].to.y){
                    inter:for(let j = 0;j < pointlist[i].to.y - pointlist[i].from.y;j++){
            ...
            if(pointlist[i].from.y === pointlist[i].to.y){
                if(pointlist[i].from.x > pointlist[i].to.x){
                    inter:for(let j = 0;j < pointlist[i].from.x - pointlist[i].to.x;j++){
                ...
                if(pointlist[i].from.x < pointlist[i].to.x){
                    inter:for(let j = 0;j < pointlist[i].to.x - pointlist[i].from.x;j++){
    ...
    render(){
        ...
        if(liststring != "{}" && this.state.oldlist !== liststring){
